                ...
                <ul className="navbar-nav navbar-align">
                        ...
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0" aria-labelledby="messagesDropdown">
                            ...
                            <div className="list-group">
                                ...
                                <a href="#" className="list-group-item">
                                    <div className="row g-0 align-items-center">
                                        <div className="col-2">
                                            <img src="../assets/../assets/img/avatars/avatar-4.jpg" className="avatar img-fluid rounded-circle" alt="Christina Mason" />
                                        </div>
                                        <div className="col-10 pl-2">
                    ...
                    <li className="nav-item dropdown">
                        ...
                        <a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-toggle="dropdown">
                            <img src="../assets/img/avatars/avatar.jpg" className="avatar img-fluid rounded mr-1" alt="Charles Hall" /> <span className="text-dark">Charles Hall</span>
                        </a>
